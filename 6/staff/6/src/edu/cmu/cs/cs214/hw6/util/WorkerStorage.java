...
/**
 * This class provides quick-and-easy access to a worker's data storage
 * directories.
 */
public final class WorkerStorage {
    ...
    // Not included as part of the starter code.
    public static final String INTERMEDIARY_RESULTS_FILE = "output_tablet_%s.txt";
